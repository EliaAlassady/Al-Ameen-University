...
export default function InfoCardItem({ Icon, title, subTitle, path }) {
    return (
        (path ? <Link to={path} target="_blank" className="perspective-1000 bg-white cursor-pointer
            w-[calc(100%-1.5rem)]
            sm:w-[calc(50%-1.5rem)]
            md:w-[calc(50%-1.5rem)]
        ...
        </Link> : <div className="perspective-1000 bg-white cursor-pointer
                             w-[calc(100%-1.5rem)]
                             sm:w-[calc(50%-1.5rem)]
                             md:w-[calc(50%-1.5rem)]
                             lg:w-[calc(33.333%-1.5rem)]
